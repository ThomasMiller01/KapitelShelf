...
import type { BookDTO } from "../../../lib/api/KapitelShelf.Api/index.ts";
import { useAddResultToLibrary } from "../hooks/api/useAddResultToLibrary";
import { LocationUrl } from "../../location/utils/LocationUtils";
import { FormatTimeUntil } from "../../../shared/utils/TimeUtils";
import ItemCardLayout, {
  MetadataItem,
} from "../../../shared/components/layout/ItemCard/ItemCardLayout";
