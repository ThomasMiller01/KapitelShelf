...
import { AutoComplete } from "../../../shared/components/base/AutoComplete";
import FileUploadButton from "../../../shared/components/base/FileUploadButton";
import ItemList from "../../../shared/components/base/ItemList";
import { useApi } from "../../../shared/contexts/ApiProvider";
import { useAiEnabled } from "../../settings/ai/hooks/useAiEnabled";
...
import { useAiGenerateCategoriesTags } from "../hooks/api/useAiGenerateCategoriesTags";
import { useProxyCover } from "../hooks/api/useProxyCover";
import type { BookFormValues } from "../utils/BookSchema";
import { BookSchema } from "../utils/BookSchema";
import { ImageTypes } from "../../../shared/utils/FileTypesUtils";
import { BookFileUrl, RenameFile, UrlToFile } from "../../../shared/utils/FileUtils";
import { toLocationTypeDTO } from "../../location/utils/LocationUtils";
import EditableLocationDetails from "../../location/components/EditableLocationDetails";
import MetadataDialog from "../../metadata/components/MetadataDialog";
