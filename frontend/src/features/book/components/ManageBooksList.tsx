...
import {
  ...
  LinkColumn,
  ManageItemsTable,
} from "../../../shared/components/ManageItemsTable";
import { ApiClients, useApi } from "../../../shared/contexts/ApiProvider";
import { useItemsTableParams } from "../../../shared/hooks/useItemsTableParams";
import { BookDTO, CategoryDTO, TagDTO } from "../../../lib/api/KapitelShelf.Api/index.ts";
import { useBooksList } from "../hooks/api/useBooksList";
import { useDeleteBooks } from "../hooks/api/useDeleteBooks";
import { useUpdateBook } from "../hooks/api/useUpdateBook";
import { normalizeBook } from "../utils/BookUtils";
import { LocationTypeToString } from "../../location/utils/LocationUtils";
