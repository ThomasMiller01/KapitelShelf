...
import { BookDTO, FileInfoDTO } from "../../../lib/api/KapitelShelf.Api/index.ts";
import { BookFileUrl, UrlToFile } from "../../../shared/utils/FileUtils";
import { BookContent } from "../utils/BookContentModels";
import { ParseEpub } from "../utils/EpubReader";
import { ParseFb2 } from "../utils/Fb2Reader";
import { ParsePdf } from "../utils/PdfReader";
import { ParseTxt } from "../utils/TxtReader";
