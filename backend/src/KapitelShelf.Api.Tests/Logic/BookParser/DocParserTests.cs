...
public class DocParserTests
{
    ...
    [Test]
    public async Task Parse_ParsesAllFields_FromRealDoc()
    {
        // Setup
        var parser = new DocParser();
        var file = GetFormFile("AllFields.doc", subDir: "Doc");
    ...
    public async Task Parse_UsesFileNameAsTitle_WhenTitleIsEmpty()
    {
        // Setup
        var parser = new DocParser();
        var file = GetFormFile("NoTitle.doc", subDir: "Doc");
    ...
    public async Task Parse_EmptyAuthor_WhenNonePresent()
    {
        // Setup
        var parser = new DocParser();
        var file = GetFormFile("NoAuthor.doc", subDir: "Doc");
    ...
    private static IFormFile GetFormFile(string fileName, string subDir = "")
    {
